...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('@MoviesLandBackup', url="https://t.me/MoviesLandBackup") ] ] ))
                else:
                    await query.answer(f"𝖧𝖾𝗒 {query.from_user.first_name}, 𝖳𝗁𝗂𝗌 𝗂𝗌 𝗇𝗈𝗍 𝗒𝗈𝗎𝗋 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 !", show_alert=True)
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('@MoviesLandFamily', url="https://t.me/MoviesLandFamily") ] ] ))
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("𝖢𝗈𝗇𝗍𝖺𝖼𝗍", url="t.me/MoviesLandAdmin_bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>👋 𝖧𝖾𝗒 {message.from_user.mention}\n Found {str(total_results)} 𝖥𝗂𝗅𝖾𝗌 & 𝖠𝗋𝖾 𝖱𝖾𝖺𝖽𝗒\n\n♨️ 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝙱𝚢 @MoviesLandFamily</b>"
